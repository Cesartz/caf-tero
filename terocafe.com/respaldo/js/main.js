(function () {
  ...
  var navigation = function () {
    $('body').on(
      'click',
      '#tero-offcanvas ul a:not([class="external"]), .main-nav a:not([class="external"])',
      function (event) {
        ...
        if ($('[data-section="' + section + '"]').length) {
          if ($('body').hasClass('active')) {
            $('html, body').animate(
              {
                scrollTop:
                  $('[data-section="' + section + '"]').offset().top - 85,
              },
              800,
              'easeInOutExpo'
            );
    ...
    $('#tero-logo a').on('click', function (event) {
      $('html, body').animate(
        { scrollTop: $('[data-section="home"]').offset().top - 85 },
        800,
        'easeInOutExpo'
      );
      event.preventDefault();
  ...
  var offcanvasMenu = function () {
    ...
    $('body').prepend(
      '<a href="#" class="js-tero-nav-toggle tero-nav-toggle"><i></i></a>'
    );
    ...
    $('#tero-offcanvas').find('li').removeClass('has-dropdown');
...
$(document).ready(function () {
  ...
  var imgrotate1 = [
    'images/icon-smiley.png',
    'images/icon-cactus.png',
    'images/icon-car.png',
    'images/icon-caras.png',
    'images/icon-carro.png',
    'images/icon-cigarro.png',
    'images/icon-manos.png',
    'images/icon-mundo.png',
    'images/icon-paloma.png',
    'images/icon-panuelo.png',
    'images/icon-sax.png',
    'images/icon-semaforo.png',
  ];
  var counter1 = 0;
  ...
  function change1() {
    $elem1
      .css({ 'background-image': "url('" + imgrotate1[counter1] + "')" })
      .fadeOut(0)
      .delay(50)
      .fadeIn(0);
    counter1++;
