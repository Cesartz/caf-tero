...
$(document).ready(function () {
	...
	var imgrotate1 = [urlBaseweb + "images/icon-smiley.png", urlBaseweb + "images/icon-cactus.png", urlBaseweb + "images/icon-car.png", urlBaseweb + "images/icon-caras.png",
						urlBaseweb +"images/icon-carro.png", urlBaseweb + "images/icon-cigarro.png", urlBaseweb + "images/icon-manos.png", urlBaseweb + "images/icon-mundo.png",
						urlBaseweb + "images/icon-paloma.png", urlBaseweb + "images/icon-panuelo.png", urlBaseweb + "images/icon-sax.png", urlBaseweb + "images/icon-semaforo.png"];
	var counter1 = 0;
